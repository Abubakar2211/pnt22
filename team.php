...
<div class="content container">
    ...
    <div class="form-container mb-3">
        <form action="" id="team-form" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="mb-3 col-md-4 ">
                    ...
                    <input type="name" class="form-control" id="designation" placeholder="Enter designation" name="designation">
                </div>
                <div class="mb-3 col-md-4 ">
    ...
    <!-- Display DataTable -->
    <div class="datatable-container mt-4" id="team-table">
...
<script>
    $(document).ready(function() {
        ...
        $('#team-submit').on("click", function(e) {
            ...
            var contact = $("#designation").val();
            var category = $('#category').val();
            var password = $("#password").val();

            if (name == "" || email == "" || contact == "" || designation == "" || !category || password == "") {
                $('#response').fadeIn();
        ...
        $(document).on("click", ".edit-btn", function() {
            var teamId = $(this).data("eid");

            $("#update-modal .modal-content").html("");
            $("#update-modal").modal('show');

            $.ajax({
                url: "team-update-form.php",
                type: "POST",
                data: {
                    id: teamId
                },
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 1) {
                        ...
                        alert("Error updating team data: " + data);
                    }
                },
